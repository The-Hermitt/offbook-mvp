...
// ---------- Async Gallery DB Helpers (work on both SQLite + Postgres) ----------

export async function galleryListByUser(userId: string): Promise<any[]> {
...
export async function galleryGetById(id: string, userId: string): Promise<any | null> {
...
export async function gallerySave(take: {
  id: string;
  user_id: string;
  script_id?: string | null;
  scene_id?: string | null;
...
export async function galleryDeleteById(id: string, userId: string): Promise<number> {
...
export async function galleryUpdateNotes(id: string, userId: string, notes: string): Promise<void> {
  await dbRun(
